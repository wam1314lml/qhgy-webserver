        ...
        <div class="log-right-panel max-h-[70vh]">
          ...
          <div class="log-search">
            ...
            <div class="search-controls">
              ...
              <a-tag color="blue">
                显示 {{ computedLogData.filteredLines.length }} 条日志 (最近5000条)
              </a-tag>
            </div>
          </div>

          <!-- 日志内容 -->
          <div class="log-content overflow-y-auto" ref="logContentRef" @scroll="handleScroll">
            <div v-if="computedLogData.filteredLines.length > 0">
              <div
                v-for="(lineInfo, index) in computedLogData.filteredLines"
                :key="index"
                class="log-line"
              >
                <div class="log-content-text" v-html="formatLogLine(lineInfo)"></div>
              </div>
            </div>
...
const computedLogData = computed(() => {
  ...
  const lines = allLines.slice(-5000) // 取最后5000条
